            ...
            <div className="input__container-wrapper">
                <div className="input__container" style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
                    ...
                    <input
                        ...
                        style={{ flex: 1 }}
                    />
                    <button className="input__button__shadow" onClick={handleSubmit} type="button" disabled={user_no === null}>
                        저장
                    </button>
                </div>
                ...
                {loading ? (
                    ...
                    <ul>
                        {spaces.map((space, index) => (
                            <li key={space.area_no ? space.area_no : index} className="space-item">
                                <span className="space-name">{space.area_name}</span>
                                <div className="buttons-container">
                                    <button className="editBtn" onClick={() => handleEditSpace(space.area_no)}>
                                    ...
                                    <button className="button deleteBtn" onClick={() => handleDeleteSpace(space.area_no)}>
